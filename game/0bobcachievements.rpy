...
define BOBCACHIEVEMENT_LIST = (
    ...
    ("Iabk", _("Wróciłe"), _("Niespodzianka skurwysyny!")),
    ...
    ("Msnc", _("Mi się nie chce"), _("Uciekłeś przed przygodą"), True),
    ("Holy", _("Krzyżowiec"), _("Dołączyłeś do kościoła Kałacha."), True),
    ("Damm", _("Pies"), _("Zostałeś psem, takim z diamentów."), True),
    ("Smrut", _("Ale to śmierdzi"), _("Dałeś Gunowi ser."), True),
    ("Fedex", _("Kurier"), _("Po co mu to przynisłeś?"), True),
    ("Shizo", _("Schizo"), _("Gadasz ze szczurem!"), True),
    ("Mill", _("Ogar na wolności"), _("Młynarczyk jest jednak niebezpieczny."), True),
    ("Pyro", _("Roasted"), _("Nadpaliłeś sojuszników. Gratulacje, czy coś."),  True),
    ("Foch", _("Chyba ma okres"), _("Cypher się na ciebie obraził."), True),
    ("Impostor", _("CZTERY!"), _("Ten Taki gryzie piach."), True),
    ("Alesex", _("Podrywacz"), _("Żadna kobitka nie uciekła!"), True),
    ("Futa", _("Giga siur"), _("Halinka swoje w łóżku potrafi"), True),
    ("Musk", _("Giga Musk"), _("Bardzo się starałeś..."), True),
    ("Bomb", _("Vgień Vistobójczy"), _("Wysadziłeś ich, ich własną bombą."), True),
    )
